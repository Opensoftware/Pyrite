class Pdf::LecturerTimetable < Pdf::Timetable

  def initialize(lecturers, event_id, available_days)
    ...
    def draw_blocks(blocks)
      blocks.each do |block|
        ...
        bounding_box [column_position(block), block_start_point], :width => @column_size, :height => block_length do
          ...
          text_box block.rooms_names, :at => [0, bounds.top - 10], :align => :center
          font_size 4
